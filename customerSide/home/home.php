    ...
    <div class="nav-bar">
      <div class="brand">
          <a class="nav-link" href="../home/home.php#hero">
            <h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> BISTRO BREEZE</h1><span class="sr-only"></span>
          </a>
      </div>
      <div class="nav-list">
        <div class="hamburger">
...
<!-- video Background and Text Overlay -->
<section id="hero" style="position: relative;">
    ...
    <div class="hero container" style="position: relative; z-index: 1;">
        <div>
            <h1><strong><h1 class="text-center" style="font-family:Copperplate; color:whitesmoke;"> BISTRO BREEZE</h1><span></span></strong></h1>
  ...
  <section id="projects">
    ...
    <div class="yellow msg"> 
      ...
      <p>
        ...
        <span class="item-price">KSHs. <?php echo $item['item_price']; ?></span><br>
...
<section id="about" ">
  <div class="about container">
    <div class="col-right">
        ...
        <h2>Bistro Breeze Bar and Restaurant Company History:</h2>
<p>Bistro Breeze Bar and Restaurant is a well-established dining destination in the heart of Mombasa, Kenya.
   Bistro Breeze has become a popular choice for customers looking to celebrate special occasions or simply enjoy a relaxing meal, with a focus on providing delicious meals and a friendly dining experience.</p>
<p>At Bistro Breeze, we offer a diverse menu that caters to a variety of tastes. Our menu includes a wide range
   of options such as bar bites, salads, soups, and a variety of main courses. Customers can savour succulent options such as steak and ribs, chicken, lamb, seafood, burgers and sandwiches, pasta, and a variety of delectable side dishes. Our menu has been carefully curated to offer a balance of classic favourites and innovative creations, ensuring that every palate is satisfied.</p>
<p>One of our distinguishing features at Bistro Breeze is our ability to accommodate customers. 
  We strive to create an inviting and comfortable dining environment, whether guests prefer to walk in or make reservations in advance. 
  We recognise the significance of creating memorable experiences, particularly for those celebrating special occasions. 
  Bistro Breeze is a popular choice for families, couples, and groups of friends because of our attentive staff and welcoming atmosphere.</p>
<p>In addition to our indoor dining area, Bistro Breeze has an inviting outdoor bar that is open seven
   days a week from 11:00 AM to 10:00 PM. This outdoor space provides a relaxed setting for patrons to unwind and socialise while sipping on their favourite drinks and nibbling on bar bites. 
   Our bar serves a wide range of beverages, including cocktails, wines, beers, and non-alcoholic options.</p>
    ...
    <div class="contact-items">
      ...
      <div class="contact-item contact-item-bg">
        <div class="contact-info">
          ...
          <h1>Address</h1>
          <h2>Karisa Maitha/Bush Bar Road off Mombasa/Malindi Road P.O. BOX 10314 - 80101, BAMBURI - MOMBASA , KENYA., Mombasa</h2>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="footer container">
      ...
      <div class="social-icon">
        <div class="social-item">
          <a href="https://www.facebook.com" target="blank"><img src="https://img.icons8.com/color/48/facebook.png" alt="facebook"/></a>
        </div>
        <div class="social-item">
          <a href="https://www.instagram.com" target="blank"><img src="https://img.icons8.com/color/48/instagram-new.png" alt="instagram-new"/></a>
        </div>
          <div class="social-item">
          <a href="https://www.pinterest.com" target="blank"><img src="https://img.icons8.com/color/48/pinterest.png" alt="pinterest-new"/></a>
        </div>
          <div class="social-item">
          <a href="https://www.tiktok.com" target="blank"><img src="https://img.icons8.com/color/48/tiktok.png" alt="tiktok-new" /></a>
        </div>
          <div class="social-item">
          <a href="https://www.youtube.com" target="blank"><img src="https://img.icons8.com/color/48/youtube-play.png" alt="youtube-new"/></a>
        </div>
          
        
      </div>
      <p>© 2024 Bistro Breeze Dining & Bar</p>
