...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email_err) && empty($member_name_err) && empty($password_err) && empty($phone_number_err)) {
        ...
        if ($stmt_accounts = mysqli_prepare($link, $sql_accounts)) {
            ...
            // Set parameters
            $param_email = $email;
            $param_password = password_hash($password, PASSWORD_DEFAULT); // Hash the password here
...
<body>
    <div class="register-container">
        <div class="register_wrapper">
            <a class="nav-link" href="../home/home.php#hero"> <h1 class="text-center" style="font-family:Copperplate; color:white;"> BISTRO BREEZE</h1><span class="sr-only"></span></a><br>
