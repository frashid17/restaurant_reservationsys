                            ...
                            <div style="max-height: 40rem;overflow-y: auto;">
                                ...
                                if ($cart_result && mysqli_num_rows($cart_result) > 0) {
                                    while ($cart_row = mysqli_fetch_assoc($cart_result)) {
                                        ...
                                        echo '<td>KSHs ' . number_format($item_price,2) . '</td>';
                                        echo '<td>' . $quantity . '</td>';
                                        echo '<td>KSHs ' . number_format($total,2) . '</td>';
                                        // Check if the bill has been paid
                                        $payment_time_query = "SELECT payment_time FROM Bills WHERE bill_id = '$bill_id'";
                                        $payment_time_result = mysqli_query($link, $payment_time_query);
                                        $has_payment_time = false;
    ...
    <table class="table table-bordered ">
        <tbody>
            <tr>
                ...
                <td>KSHs<?php echo number_format($cart_total, 2); ?></td>
            </tr>
            <tr>
                <td><strong>Cart Taxed</strong></td>
                <td>KSHs <?php echo number_format($cart_total * $tax, 2); ?></td>
            </tr>
            <tr>
                <td><strong>Grand Total</strong></td>
                <td>KSHs <?php echo number_format(($tax * $cart_total) + $cart_total, 2); ?></td>
            </tr>
        </tbody>
    </table>
</div>
                        ...
                        //echo "Cart Total: KSHs " . $cart_total;
                        //echo "<br>Cart Taxed: KSHs " . $cart_total * $tax;
                        //echo "<br>Grand Total: KSHs " . $tax * $cart_total + $cart_total;
