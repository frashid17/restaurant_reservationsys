        ...
        <div class="col-md-8">
            ...
            ?>
                    ...
                    <div class="text-right">
                        <?php 
                        echo "<strong>Total:</strong> KSHs " . number_format($cart_total, 2) . "<br>";
                        echo "<strong>Tax (16%):</strong> KSHs " . number_format($cart_total * $tax, 2) . "<br>";
                        $GRANDTOTAL = $tax * $cart_total + $cart_total;
                        echo "<strong>Grand Total:</strong> KSHs " . number_format($GRANDTOTAL, 2);
                        ?>
                    </div>
    ...
    <div class="row">
        ...
        if (isset($_GET['payment_amount'])) {
            ...
            if ($payment_amount >= $GRANDTOTAL) {
                ...
                echo "Change is KSHs" . number_format(calculateChange($payment_amount, $GRANDTOTAL),2);
                echo '</div>';
